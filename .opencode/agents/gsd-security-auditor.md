...
**Verification depth scales with `asvs_level`** (see @/home/diplo/projects/game-of-life/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
