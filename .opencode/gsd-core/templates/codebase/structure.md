...
- Usage: Reference from command with `@/home/diplo/projects/game-of-life/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/diplo/projects/game-of-life/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/diplo/projects/game-of-life/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
