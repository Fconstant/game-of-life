...
<required_reading>
@/home/diplo/projects/game-of-life/.opencode/gsd-core/references/ai-frameworks.md
@/home/diplo/projects/game-of-life/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/diplo/projects/game-of-life/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/diplo/projects/game-of-life/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/diplo/projects/game-of-life/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/diplo/projects/game-of-life/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/diplo/projects/game-of-life/.opencode/agents/gsd-eval-planner.md for instructions.
