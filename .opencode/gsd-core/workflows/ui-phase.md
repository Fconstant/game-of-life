...
```markdown
Read /home/diplo/projects/game-of-life/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/diplo/projects/game-of-life/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/diplo/projects/game-of-life/.opencode/agents/gsd-ui-checker.md for instructions.
...
@/home/diplo/projects/game-of-life/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/diplo/projects/game-of-life/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/diplo/projects/game-of-life/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/diplo/projects/game-of-life/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
If `$APPLICABLE` is `0`, do NOT proceed silently: ask via question ("The UI probe found no
...
So SURFACE the detected kinds to the user (question) and ask whether any real element kind
...
question — **Specify** (→ `covered`, write a concrete truth) / **Dismiss (reason required)** /
...
**Kind-confirmation under `--auto`.** The propose-then-confirm step above is an question, so
under `--auto` it follows the spec-phase 5.5 convention (replace question with the agent's
