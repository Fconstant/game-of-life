...
Key references:
- @/home/diplo/projects/game-of-life/.opencode/gsd-core/references/ui-brand.md (display patterns)
- @/home/diplo/projects/game-of-life/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/diplo/projects/game-of-life/.opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/diplo/projects/game-of-life/.opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/diplo/projects/game-of-life/.opencode/gsd-core/USER-PROFILE.md" "/home/diplo/projects/game-of-life/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/diplo/projects/game-of-life/.opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/diplo/projects/game-of-life/.opencode/gsd-core/references/user-profiling.md`
...
Reference: @/home/diplo/projects/game-of-life/.opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/diplo/projects/game-of-life/.opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/diplo/projects/game-of-life/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/diplo/projects/game-of-life/.opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/diplo/projects/game-of-life/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/diplo/projects/game-of-life/.opencode/AGENTS.md"

**Error handling:** If any `gsd-tools.cjs query` or gsd-tools.cjs call fails, display the error message and use question to offer "Retry" or "Skip this artifact". On retry, re-run the command. On skip, continue to next artifact.
...
```bash
BACKUP_PATH="/home/diplo/projects/game-of-life/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /home/diplo/projects/game-of-life/.opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/diplo/projects/game-of-life/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.opencode/AGENTS.md>
  ✓ Global AGENTS.md        /home/diplo/projects/game-of-life/.opencode/AGENTS.md
```

(Show the `claude_md_path` actually returned by the command — it defaults to `./.opencode/AGENTS.md` but may be overridden by config or `--output`.)
