...
- ./AGENTS.md or ./.opencode/AGENTS.md (if exists — project-specific guidelines)
...
- ./AGENTS.md or ./.opencode/AGENTS.md (if exists — follow project-specific guidelines)
...
- ${STATE_PATH} (Project state)
- ./AGENTS.md or ./.opencode/AGENTS.md (Project instructions, if exists)
