...
- **Global scope**: `/home/diplo/projects/game-of-life/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/diplo/projects/game-of-life/.opencode/notes/`)
...
2. Glob `/home/diplo/projects/game-of-life/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/diplo/projects/game-of-life/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/diplo/projects/game-of-life/.opencode/notes/` — works in any directory
