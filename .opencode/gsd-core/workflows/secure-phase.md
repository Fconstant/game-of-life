...
```
Agent(
  prompt="Read /home/diplo/projects/game-of-life/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/diplo/projects/game-of-life/.opencode/gsd-core/templates/SECURITY.md`
